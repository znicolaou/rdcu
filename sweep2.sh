...
#for j in `seq 1 11`; do
	...
	if [ ! -f scratch/3dcgle/${i}/${j}/faces.dat ]; then 
		echo "./makelines.py --states 0 --threads 50 --T 2000 --dt 0.1 --T1 1900 --dt1 10 --rm 1 --Ns 128 128 128 --Ls 200 200 200 --filebase scratch/3dcgle/${i}/${j}/ &"
		./makelines.py --states 0 --threads 50 --T 2000 --dt 0.1 --T1 1900 --dt1 10 --rm 1 --Ns 128 128 128 --Ls 200 200 200 --filebase scratch/3dcgle/${i}/${j}/ &
	fi
#done
wait
